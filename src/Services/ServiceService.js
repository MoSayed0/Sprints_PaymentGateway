...
var serviceRepo = new ServiceRepository_1.ServiceRepository();
var ServiceService = /** @class */ (function () {
    function ServiceService() {
    }
    ServiceService.prototype.create = function (data) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        service = new Service_Model_1.Service(data.typeId, data.name, data.feesAmount);
    ...
    ServiceService.prototype.all = function () {
        return serviceRepo.findAll();
    };
    ServiceService.prototype.findById = function (id) {
        return serviceRepo.findById(id);
    };
    ServiceService.prototype.findByIdOrFail = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var service;
